    ...
    switch (action) {
        ...
        case "sendMessage": {
            ...
            if (asVoice) {
                ...
                if (content && content.trim()) {
                    throw new Error("Voice messages cannot include text content (Discord limitation). Remove the content parameter.");
                }
        ...
        case "threadCreate": {
            ...
            const thread = accountId
                ? await createThreadDiscord(channelId, { name, messageId, autoArchiveMinutes, content }, { accountId })
