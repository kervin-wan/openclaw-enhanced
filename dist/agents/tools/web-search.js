...
const WebSearchSchema = Type.Object({
    ...
    search_lang: Type.Optional(Type.String({
        description: "ISO language code for search results (e.g., 'de', 'en', 'fr'). For Chinese use 'zh-hans' (Simplified) or 'zh-hant' (Traditional); bare 'zh' is auto-mapped to 'zh-hans'.",
    })),
...
function missingSearchKeyPayload(provider) {
    ...
    return {
        ...
        message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("openclaw-enhanced configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
        docs: "https://docs.clawd.bot/tools/web",
    };
}
...
async function runWebSearch(params) {
    ...
    if (params.search_lang) {
        url.searchParams.set("search_lang", normalizeBraveLang(params.search_lang) ?? params.search_lang);
    }
    if (params.ui_lang) {
