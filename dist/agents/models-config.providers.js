...
function buildDashscopeProvider() {
    return {
...
export async function resolveImplicitProviders(params) {
    ...
    const dashscopeKey = resolveEnvApiKeyVarName("dashscope") ??
    ...
    const deepseekKey = resolveEnvApiKeyVarName("deepseek") ??
...
export function buildVolcengineProvider() {
    return {
