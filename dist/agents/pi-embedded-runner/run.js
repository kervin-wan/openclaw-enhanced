...
export async function runEmbeddedPiAgent(params) {
    ...
    return enqueueSession("EMBEDDED_PI_RUN", { ...params, __dispatchedViaQueue: true }, { onWait: params.onWait }).then(() => enqueueGlobal("EMBEDDED_PI_RUN", { ...params, __dispatchedViaQueue: true }, { onWait: params.onWait }).then(async () => {
        ...
        try {
            while (true) {
                ...
                const { aborted, promptError, timedOut, timedOutDuringCompaction, 
                // @ts-ignore -- cherry-pick upstream type mismatch
                sessionIdUsed, lastAssistant, } = attempt;
