...
export async function runEmbeddedAttempt(params) {
    ...
    try {
        ...
        try {
            ...
            toolMetas, 
            // @ts-ignore -- cherry-pick upstream type mismatch
            unsubscribe, waitForCompactionRetry, getMessagingToolSentTexts, getMessagingToolSentTargets, didSendViaMessagingTool, getLastToolError, 
            // @ts-ignore -- cherry-pick upstream type mismatch
            getUsageTotals, 
            // @ts-ignore -- cherry-pick upstream type mismatch
            getCompactionCount, } = subscription;
            const queueHandle = {
